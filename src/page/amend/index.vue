    ...
    <div class="body">
        ...
        <form ref="cent">
            <div class="info">
                <div class="input">
                    <span>旧密码：</span>
                    <input type="password" v-model="lpassword" @input="filName('password')" @blur="blur('lpassword')"  maxlength="18" />
    ...
    methods:{
        ...
        blur(key){
            switch(key){
                case "lpassword": 
                    if(this.lpassword){
                        if(this.lpassword.length > 7){
                            this.info_lpassword = "";
                        }else{
                            this.v_password = false;
                            this.$refs.hint_lpassword.setAttribute("class","iconfont icon-icon1");
                            this.info_lpassword = "由8至16位字符组成";
                        };
                    }else{
                        this.v_password = false;
        ...
        regInfo () {
            if(!this.v_lpassword){
                ...
                alert(this.password,this.affirm,this.verify);
                console.log(this.lpassword);
                if(this.lpassword === "123456789"){
                    this.v_lpassword = true;
                    this.$refs.hint_lpassword.setAttribute("class","iconfont icon-duigou");
